...
const ProjectsAbout = () => {
  return (
      <div className="bg-white lg:pl-28 space-y-1">
      ...
      <div className="pt-5 pl-6">
        ...
        <h1 className="text-xl  text-black space-y-5">
          Communicative, Collaborative, Time Management Ability, Leadership,
          Team Work
        </h1>
      </div>
      <div className="pt-5 pl-6">
        <h1 className="text-2xl font-bold text-black">Operating System</h1>
        <h1 className="text-xl  text-black space-y-5">Windows, Linux</h1>
      </div>
    </div>
  );
};
